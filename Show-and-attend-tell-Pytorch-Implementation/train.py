...
attention_dim = 512  # attention线性层维数(计算score时的MLP)
...
# 训练参数
start_epoch = 0
epochs = 120  # epoch数目，除非early stopping
...
decoder_lr = 4e-4 
grad_clip = 5.  # 梯度裁剪阈值
alpha_c = 1.  # 论文中的'doubly stochastic attention'的正则化参数 论文中的\lambda
...
def train(train_loader, encoder, decoder, criterion, encoder_optimizer, decoder_optimizer, epoch):
    ...
    for i, (imgs, caps, caplens) in enumerate(train_loader):
        ...
        #正则项: doubly stochastic attention regularization
...
def validate(val_loader, encoder, decoder, criterion):
    ...
    with torch.no_grad():
        ...
        for i, (imgs, caps, caplens, allcaps) in enumerate(val_loader):
            ...
            scores_copy = scores.clone()  # 未进行pad的
            ...
            # 添加正则项 doubly stochastic attention regularization
            loss += alpha_c * ((1. - alphas.sum(dim=1)) ** 2).mean()
